...
function TermsConditions() {
  ...
  return (
    <>
      <TopNavbar />
      <Wrapper id="terms">
        <div className="whiteBg themeDarkColor" style={{ padding: "100px 0" }}>
          {/* Terms & Conditions */}
          <div className="container">
            <HeaderInfo>
              <h1 className="font40 extraBold">Terms and Conditions</h1>
            </HeaderInfo>
          </div>
          ...
          <div className="container tcBlock">
            ...
            <p className="font18">
              ...
              support@indiansabroad.online. If we ever grant you the permission
            ...
            <p className="font18">
              ...
              <br />
              <b className="greyColor">Submissions:</b> By directly sending us
              ...
              you.
              <br />
              <b className="greyColor">Contributions:</b> The Services may
              invite you to chat, contribute to, or participate in blogs,
              message boards, online forums, and other functionality during
              which you may create, submit, post, display, transmit, publish,
              distribute, or broadcast content and materials to us or through
          ...
          <div className="container tcBlock">
            ...
            <p className="font18">
              ...
              Terms to the jurisdiction of the India courts. EXPONATE ONLINE
              SERVICES PVT LTD shall also maintain the right to bring
          ...
          <div className="container tcBlock">
            ...
            <p className="font18">
              <Link className="skyBlueColor">support@indiansabroad.online</Link>
            </p>
            <p className="font18">
              These terms of use were created using Termly's{" "}
              <Link className="skyBlueColor">
